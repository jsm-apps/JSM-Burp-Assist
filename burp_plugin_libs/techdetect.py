...
class OllamaWorker(Runnable):
    ...
    def __init__(self, path, task_id, url, message, question, raw_response, on_complete, on_error=None):
        self.path = path
    ...
    def run(self):
        try:
            ...
            task = client.create_task(self.path, self.url, self.raw_response, self.question)
